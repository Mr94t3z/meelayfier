document.addEventListener('DOMContentLoaded', function() {
    ...
    chrome.storage.sync.get('enabled', function(data) {
        ...
        statusText.textContent = data.enabled ? "You're Meelayfying! Just reload the uh,\n you know - you know the thing." : "Meelayfier disabled,\n you dog-faced pony soldier!";
    ...
    toggle1.addEventListener('change', function() {
        ...
        chrome.storage.sync.set({'enabled': enabled}, function() {
            statusText.textContent = enabled ? "You're Meelayfying! Just reload the uh,\n you know - you know the thing." : "Meelayfier disabled,\n you dog-faced pony soldier!";
